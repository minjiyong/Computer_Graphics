...
void Importer::ReadObj() {
    ...
    VertexData* newVertexData7 = new VertexData;

    newVertexData7->filename = "cube_top";

    temp_vertex = { 1.0f, 0.0f, -1.0f };
    temp_color = { (float)(rand() % 256) / 255.0f, (float)(rand() % 256) / 255.0f, (float)(rand() % 256) / 255.0f };
    newVertexData7->vertex.push_back(temp_vertex);
    newVertexData7->color.push_back(temp_color);
    ...
    VertexBuffers.push_back(newVertexData7);
    SetupMesh(VertexBuffers.back());


    VertexData* newVertexData8 = new VertexData;

    newVertexData8->filename = "cube_front";

    temp_vertex = { -1.0f, 0.0f, 0.0f };
    temp_color = { (float)(rand() % 256) / 255.0f, (float)(rand() % 256) / 255.0f, (float)(rand() % 256) / 255.0f };
    newVertexData8->vertex.push_back(temp_vertex);
    newVertexData8->color.push_back(temp_color);
    ...
    VertexBuffers.push_back(newVertexData8);
    SetupMesh(VertexBuffers.back());


    VertexData* newVertexData9 = new VertexData;

    newVertexData9->filename = "pyramid_side";

    temp_vertex = { 0.0f, 0.8f, 0.0f };
    temp_color = { (float)(rand() % 256) / 255.0f, (float)(rand() % 256) / 255.0f, (float)(rand() % 256) / 255.0f };
    newVertexData9->vertex.push_back(temp_vertex);
    newVertexData9->color.push_back(temp_color);

    temp_vertex = { -0.4f, 0.0f, 0.0f };
    temp_color = { (float)(rand() % 256) / 255.0f, (float)(rand() % 256) / 255.0f, (float)(rand() % 256) / 255.0f };
    newVertexData9->vertex.push_back(temp_vertex);
    newVertexData9->color.push_back(temp_color);
    ...
    VertexBuffers.push_back(newVertexData9);
    SetupMesh(VertexBuffers.back());


    /*VertexData* newVertexData10 = new VertexData;

    newVertexData10->filename = "pyramid_side2";

    temp_vertex = { 0.0f, 0.8f, 0.0f };
    temp_color = { (float)(rand() % 256) / 255.0f, (float)(rand() % 256) / 255.0f, (float)(rand() % 256) / 255.0f };
    newVertexData10->vertex.push_back(temp_vertex);
    newVertexData10->color.push_back(temp_color);

    temp_vertex = { 0.4f, 0.0f, -0.4f };
    temp_color = { (float)(rand() % 256) / 255.0f, (float)(rand() % 256) / 255.0f, (float)(rand() % 256) / 255.0f };
    newVertexData10->vertex.push_back(temp_vertex);
    newVertexData10->color.push_back(temp_color);
    ...
    VertexBuffers.push_back(newVertexData10);
    SetupMesh(VertexBuffers.back());


    VertexData* newVertexData11 = new VertexData;

    newVertexData11->filename = "pyramid_side3";

    temp_vertex = { 0.0f, 0.8f, 0.0f };
    temp_color = { (float)(rand() % 256) / 255.0f, (float)(rand() % 256) / 255.0f, (float)(rand() % 256) / 255.0f };
    newVertexData11->vertex.push_back(temp_vertex);
    newVertexData11->color.push_back(temp_color);
    ...
    VertexBuffers.push_back(newVertexData11);
    SetupMesh(VertexBuffers.back());


    VertexData* newVertexData12 = new VertexData;

    newVertexData11->filename = "pyramid_side4";

    temp_vertex = { 0.0f, 0.8f, 0.0f };
    temp_color = { (float)(rand() % 256) / 255.0f, (float)(rand() % 256) / 255.0f, (float)(rand() % 256) / 255.0f };
    newVertexData12->vertex.push_back(temp_vertex);
    newVertexData12->color.push_back(temp_color);
    ...
    VertexBuffers.push_back(newVertexData12);
    SetupMesh(VertexBuffers.back());*/
}
